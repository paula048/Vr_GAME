...
public class SlimeKilled_test2 : MonoBehaviour

{
    ...
    public void Break()         // here means death funtion
    {
		...
		vacuum = GameObject.FindWithTag("Vacuum_test");
		Renderer rend = vacuum.GetComponent<Renderer>();
		rend.material.color = Color.black;
		vacuum.GetComponent<VacuumColider_test2>().VacuumCleaning(this.gameObject);
    }
}
